...
class Provider(pulumi.ProviderResource):
    def __init__(__self__, resource_name, opts=None, apikey=None, baseurl=None, __props__=None, __name__=None, __opts__=None):
        """
        ...
        if opts.id is None:
            ...
            if apikey is None:
                apikey = utilities.get_env('CLOUDAMQP_APIKEY')
