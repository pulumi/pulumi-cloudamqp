...
class GetPluginsCommunityResult:
    ...
    @property
    @pulumi.getter
    def plugins(self) -> Optional[List['outputs.GetPluginsCommunityPluginResult']]:
...
def get_plugins_community(instance_id: Optional[float] = None,
                          plugins: Optional[List[pulumi.InputType['GetPluginsCommunityPluginArgs']]] = None,
