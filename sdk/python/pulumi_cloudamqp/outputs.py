...
class IntegrationLogAgentCloudwatch(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str log_stream: The name of the CloudWatch log stream. Defaults to the cluster name if not set. Recommended to set explicitly to `cloudamqp_instance.instance.cluster_name`.
...
class IntegrationMetricPrometheusPrometheusRemoteWrite(dict):
    ...
    def __init__(__self__, *,
        ...
        :param _builtins.str auth_type: Authentication for the endpoint. Valid values: `none`, `basic_auth`, `headers`, `oauth2`. Default: `none`.
        :param _builtins.str client_id: Client identifier. Required when `auth_type` is `oauth2`.
        :param _builtins.str client_secret: Client secret. Required when `auth_type` is `oauth2`.
        ...
        :param _builtins.str tags: Additional tags to attach to metrics. Format: `key=value,key2=value2`.
        :param _builtins.str token_url: OAuth2 token endpoint over HTTPS. Required when `auth_type` is `oauth2`.
...
@pulumi.output_type
class TrustStoreFile(dict):
    def __init__(__self__, *,
                 certificates: Optional[Sequence['outputs.TrustStoreFileCertificate']] = None):
        """
        :param Sequence['TrustStoreFileCertificateArgs'] certificates: A list of certificate blocks (1-100 certificates). Each
    ...
    @_builtins.property
    @pulumi.getter
    def certificates(self) -> Optional[Sequence['outputs.TrustStoreFileCertificate']]:
        """
...
@pulumi.output_type
class TrustStoreFileCertificate(dict):
    def __init__(__self__, *,
                 content: Optional[_builtins.str] = None,
                 name: Optional[_builtins.str] = None):
        """
        :param _builtins.str content: **NOTE:** This field is write-only and its value will not be updated in state as part of read operations.
               PEM-encoded x.509 formatted leaf certificate content.
               
               Updates require incrementing `version` or changing `key_id`.
        :param _builtins.str name: A unique identifier for the certificate.
        """
...
class TrustStoreHttp(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str url: URL to fetch trust store certificates from. RabbitMQ will periodically fetch
