...
namespace Pulumi.CloudAmqp.Inputs
{
    ...
    public sealed class TrustStoreHttpArgs : global::Pulumi.ResourceArgs
    {
        [Input("cacert")]
        ...
        public TrustStoreHttpArgs()
        {
        }
        public static new TrustStoreHttpArgs Empty => new TrustStoreHttpArgs();
    }
}
