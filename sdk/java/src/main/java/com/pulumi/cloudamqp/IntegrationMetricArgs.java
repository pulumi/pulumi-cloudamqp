...
public final class IntegrationMetricArgs extends com.pulumi.resources.ResourceArgs {

    public static final IntegrationMetricArgs Empty = new IntegrationMetricArgs();
    ...
    public static Builder builder(IntegrationMetricArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new IntegrationMetricArgs();
        }

        public Builder(IntegrationMetricArgs defaults) {
            $ = new IntegrationMetricArgs(Objects.requireNonNull(defaults));
        }
        ...
        public IntegrationMetricArgs build() {
            if ($.instanceId == null) {
                throw new MissingRequiredPropertyException("IntegrationMetricArgs", "instanceId");
            }
            return $;
        }
    }
