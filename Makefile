...
# Use gotestsum in CI for human-readable output; fall back to go test for local development.
ifdef CI
...
# `cmd/pulumi-resource-cloudamqp/schema.json` is valid and up to date.
